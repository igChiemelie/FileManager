        ...
        <div class="row">
            ...
            <div class="col s12 m10 l10 gutter">
                <?php
                    ...
                    $res = $db->query("SELECT CONCAT(users.firstname, ' ', users.lastname) as names, fileuploads.datePosted, fileuploads.id, fileuploads.mediaType, fileuploads.fileName, fileuploads.title FROM fileuploads, users WHERE fileuploads.access = 'Pub' AND fileuploads.userId = users.id ORDER BY fileuploads.datePosted  DESC");
                    $rowNum = $res->num_rows;
                                        ...
                                        <div  class="col s10 m6 l3 offset-s1">
                                            <div class="card ">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <p><a href="server/singlePic.php?fileuploadsId='.$imgArr[$a]['id'].'">View</a></p>
